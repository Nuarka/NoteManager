    ...
    <div className="min-h-screen bg-background selection:bg-primary/20">
      ...
      <nav className="fixed top-0 w-full z-50 border-b bg-background/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-black tracking-tighter">ProjectMind</span>
          </div>
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center space-y-8">
          <Badge variant="outline" className="py-1 px-4 rounded-full border-primary/20 text-primary font-bold uppercase tracking-widest text-[10px] animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link href="/dashboard">
              <Button size="lg" className="rounded-full px-8 h-14 text-lg font-black gap-2 shadow-xl shadow-primary/20 w-full sm:w-auto">
                Start Building for Free <ArrowRight className="h-5 w-5" />
              </Button>
            </Link>
            <Button size="lg" variant="outline" className="rounded-full px-8 h-14 text-lg font-bold w-full sm:w-auto">
              View Demo
            </Button>
          </div>
          ...
          <div className="mt-20 relative mx-auto max-w-5xl rounded-[2rem] border bg-card shadow-2xl overflow-hidden aspect-video group">
            ...
            <div className="w-full h-full bg-muted flex items-center justify-center p-12">
               <div className="w-full h-full rounded-xl border-2 border-dashed border-muted-foreground/20 flex flex-col items-center justify-center gap-4">
                  ...
                  <p className="text-muted-foreground/40 font-bold uppercase tracking-widest text-sm">Interactive Dashboard Interface</p>
               </div>
            </div>
      ...
      <section className="py-24 px-4 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl font-black tracking-tight">Everything you need to <span className="text-primary italic">thrive</span></h2>
            <p className="text-muted-foreground font-medium max-w-2xl mx-auto">Powerful tools built for creators, thinkers, and builders.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} className="border-none shadow-lg hover:shadow-xl transition-shadow bg-card rounded-3xl overflow-hidden group">
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto rounded-[3rem] bg-primary p-12 md:p-20 text-center text-primary-foreground relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter">Ready to clear your mind?</h2>
            <p className="text-xl text-primary-foreground/80 font-medium max-w-xl mx-auto">
              Join hundreds of users who are already organizing their thoughts with ProjectMind.
            </p>
            <Link href="/dashboard">
              <Button size="lg" variant="secondary" className="rounded-full px-10 h-16 text-xl font-black shadow-2xl">
